...
def segment(a, b):
    ...
    :param a: кортеж с координатой первой точки
    :param b: кортеж с координатой второй точки
    :return: При возникновении исключения возвращается текст задом наперед, если исключения не произошло, то сумма всех координат
    """
    try:
