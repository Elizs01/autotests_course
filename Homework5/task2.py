...
def repeats(our_str):
    """
    Считает количество встречающихся символов
    :param our_str: Строка в которой нужно посчитать количество символов
    :return: Строка с количеством встречающихся символов указанных помощью постфикса формата _n
    """
